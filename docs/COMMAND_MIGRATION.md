...
| Mentor | REST/browser page-comment create/edit/delete; page edit (atomic mutation + audit, with If-Match optimistic concurrency) | Space and page create/move/delete/restore, visibility, membership, and labels |
