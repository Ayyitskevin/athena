...
| Mentor | REST/browser page-comment create/edit/delete; page edit (atomic mutation + audit, with If-Match optimistic concurrency); page archive/restore (soft-delete) | Space and page create/move/hard-delete/version-restore, visibility, membership, and labels |
