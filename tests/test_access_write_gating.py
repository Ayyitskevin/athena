...
The gates concentrate at choke points: issue commands (visible_issue before
require_issue_writer), issue_for_read (issue comments/attachments — visibility
without modify rights),
