...
| 4 | **API safety for agent loops** | V1 safety shipped | Durable single-flight idempotency, stable official-client keys, token request limits, and issue bulk updates exist; update-race protection remains. | Add ETag/If-Match |
