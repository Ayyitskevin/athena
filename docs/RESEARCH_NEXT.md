...
Athena-to-Athena portability, and basic Jira/Confluence JSON bundle mappers. The
next best work is to make Athena auditable across agent runs and harden migration
against real-world exports: replay artifacts, real Atlassian sample fixtures, then
